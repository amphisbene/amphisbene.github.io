...
date:   2020-11-26 13:10:00 +0700
categories: [python, django, security]
---

This post is completely copied from an agus's post. This is only a test post.
Previously, the Django has [X-XSS-Protection: 1; mode=block] to handle this case.
Some browsers have the ability to block content that appears to be an XSS attack.
...
[X-XSS-Protection: 1; mode=block]: https://docs.djangoproject.com/en/dev/ref/middleware/#x-xss-protection-1-mode-block
